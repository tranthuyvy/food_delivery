...
const Home = () => {
  ...
  useEffect(() => {
    ...
    const filteredBurger = products.filter(item => item.category === 'Burger')
          ...
          <Row>
            ...
            <Col lg='6' md='6'>
              <div className='why__TV__food'>
                ...
                <p className='TV__food__desc'>Lorem, ipsum dolor sit amet consectetur adipisicing elit. Ipsum, iste.</p>
                <ListGroup className='mt-5 list__choose'>
